...
namespace UnitTests.Extensions
{
    public class IResourceStoreExtensionsTests
    {
        ...
        public class MockResourceStore : IResourceStore
        {
            ...
            public Task<IEnumerable<ApiResource>> FindApiResourcesByScopeNameAsync(IEnumerable<string> names, CancellationToken cancellationToken = default)
            {
            ...
            public Task<IEnumerable<IdentityResource>> FindIdentityResourcesByScopeNameAsync(IEnumerable<string> names, CancellationToken cancellationToken = default)
            {
                if (names == null) throw new ArgumentNullException(nameof(names));
