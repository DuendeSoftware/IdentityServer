    ...
    where T : IResourceStore
{
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("CachingResourceStore.GetKey");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("CachingResourceStore.GetAllResources");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("CachingResourceStore.FindApiResourcesByScopeName");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("CachingResourceStore.FindApiResourcesByName");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("CachingResourceStore.FindIdentityResourcesByScopeName");
        activity?.SetTag(Telemetry.Properties.ScopeNames, scopeNames.ToSpaceSeparatedString());
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("CachingResourceStore.FindApiScopesByName");
        activity?.SetTag(Telemetry.Properties.ScopeNames, scopeNames.ToSpaceSeparatedString());
