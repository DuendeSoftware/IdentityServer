    ...
    where T : ICorsPolicyService
{
    ...
    {
        using var activity = Instrumentation.StoreActivitySource.StartActivity("CachingCorsPolicyService.IsOriginAllowed");
        activity?.SetTag(Instrumentation.Properties.Origin, origin);
