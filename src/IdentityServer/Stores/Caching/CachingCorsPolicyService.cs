    ...
    where T : ICorsPolicyService
{
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("CachingCorsPolicyService.IsOriginAllowed");
        activity?.SetTag(Telemetry.Properties.Origin, origin);
