...
public class InMemoryServerSideSessionStore : IServerSideSessionStore
{
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryServerSideSessionStore.CreateSession");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryServerSideSessionStore.GetSession");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryServerSideSessionStore.UpdateSession");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryServerSideSessionStore.DeleteSession");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryServerSideSessionStore.GetSessions");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryServerSideSessionStore.DeleteSessions");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryServerSideSessionStore.GetAndRemoveExpiredSession");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryServerSideSessionStore.QuerySessions");
