...
public class InMemoryDeviceFlowStore : IDeviceFlowStore
{
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryDeviceFlowStore.StoreDeviceAuthorization");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryDeviceFlowStore.FindByUserCode");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryDeviceFlowStore.FindByDeviceCode");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryDeviceFlowStore.UpdateByUserCode");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryDeviceFlowStore.RemoveByDeviceCode");
