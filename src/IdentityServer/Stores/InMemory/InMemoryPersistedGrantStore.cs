...
public class InMemoryPersistedGrantStore : IPersistedGrantStore
{
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryPersistedGrantStoreResponseGenerator.Store");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryPersistedGrantStoreResponseGenerator.Get");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryPersistedGrantStoreResponseGenerator.GetAll");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryPersistedGrantStoreResponseGenerator.Remove");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryPersistedGrantStoreResponseGenerator.RemoveAll");
