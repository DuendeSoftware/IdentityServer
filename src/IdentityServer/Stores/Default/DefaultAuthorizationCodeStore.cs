...
public class DefaultAuthorizationCodeStore : DefaultGrantStore<AuthorizationCode>, IAuthorizationCodeStore
{
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("DefaultAuthorizationCodeStore.StoreAuthorizationCode");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("DefaultAuthorizationCodeStore.GetAuthorizationCode");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("DefaultAuthorizationCodeStore.RemoveAuthorizationCode");
