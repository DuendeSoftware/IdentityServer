...
public class DefaultUserConsentStore : DefaultGrantStore<Consent>, IUserConsentStore
{
    ...
    {
        using var activity = Instrumentation.StoreActivitySource.StartActivity("DefaultUserConsentStore.StoreUserConsent");
    ...
    {
        using var activity = Instrumentation.StoreActivitySource.StartActivity("DefaultUserConsentStore.GetUserConsent");
    ...
    {
        using var activity = Instrumentation.StoreActivitySource.StartActivity("DefaultUserConsentStore.RemoveUserConsent");
