...
public class DefaultUserConsentStore : DefaultGrantStore<Consent>, IUserConsentStore
{
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("DefaultUserConsentStore.StoreUserConsent");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("DefaultUserConsentStore.GetUserConsent");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("DefaultUserConsentStore.RemoveUserConsent");
