...
internal class ConsentMessageStore : IConsentMessageStore
{
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("ConsentMessageStore.Delete");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("ConsentMessageStore.Read");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("ConsentMessageStore.Write");
