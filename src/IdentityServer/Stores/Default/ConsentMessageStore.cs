...
internal class ConsentMessageStore : IConsentMessageStore
{
    ...
    {
        using var activity = Instrumentation.StoreActivitySource.StartActivity("ConsentMessageStore.Delete");
    ...
    {
        using var activity = Instrumentation.StoreActivitySource.StartActivity("ConsentMessageStore.Read");
    ...
    {
        using var activity = Instrumentation.StoreActivitySource.StartActivity("ConsentMessageStore.Write");
