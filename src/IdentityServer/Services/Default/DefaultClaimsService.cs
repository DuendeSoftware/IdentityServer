...
public class DefaultClaimsService : IClaimsService
{
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultClaimsService.GetIdentityTokenClaims");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultClaimsService.GetAccessTokenClaims");
