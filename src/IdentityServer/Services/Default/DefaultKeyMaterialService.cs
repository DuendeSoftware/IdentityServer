...
public class DefaultKeyMaterialService : IKeyMaterialService
{
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultKeyMaterialService.GetSigningCredentials");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultKeyMaterialService.GetAllSigningCredentials");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultKeyMaterialService.GetValidationKeys");
