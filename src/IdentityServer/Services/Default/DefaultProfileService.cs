...
public class DefaultProfileService : IProfileService
{
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultProfileService.GetProfileData");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultProfileService.IsActive");
