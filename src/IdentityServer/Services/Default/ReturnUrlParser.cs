...
public class ReturnUrlParser
{
    ...
    {
        using var activity = Telemetry.ValidationActivitySource.StartActivity("ReturnUrlParser.Parse");
    ...
    {
        using var activity = Telemetry.ValidationActivitySource.StartActivity("ReturnUrlParser.IsValidReturnUrl");
