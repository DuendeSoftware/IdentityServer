...
internal class DefaultIdentityServerInteractionService : IIdentityServerInteractionService
{
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultIdentityServerInteractionService.GetAuthorizationContext");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultIdentityServerInteractionService.GetLogoutContext");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultIdentityServerInteractionService.CreateLogoutContext");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultIdentityServerInteractionService.GetErrorContext");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultIdentityServerInteractionService.GrantConsent");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultIdentityServerInteractionService.DenyAuthorization");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultIdentityServerInteractionService.IsValidReturnUrl");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultIdentityServerInteractionService.GetAllUserGrants");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultIdentityServerInteractionService.RevokeUserConsent");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultIdentityServerInteractionService.RevokeTokensForCurrentSession");
