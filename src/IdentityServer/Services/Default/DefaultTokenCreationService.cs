...
public class DefaultTokenCreationService : ITokenCreationService
{
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultTokenCreationService.CreateToken");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultTokenCreationService.CreateJwt");
