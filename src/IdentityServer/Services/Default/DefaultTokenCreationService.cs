...
public class DefaultTokenCreationService : ITokenCreationService
{
    ...
    {
        using var activity = Instrumentation.ServiceActivitySource.StartActivity("DefaultTokenCreationService.CreateToken");
    ...
    {
        using var activity = Instrumentation.ServiceActivitySource.StartActivity("DefaultTokenCreationService.CreateJwt");
