...
public class DefaultReplayCache : IReplayCache
{
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultReplayCache.Add");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultReplayCache.Exists");
