...
public class DefaultPersistedGrantService : IPersistedGrantService
{
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultPersistedGrantService.GetAllGrants");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultPersistedGrantService.RemoveAllGrants");
