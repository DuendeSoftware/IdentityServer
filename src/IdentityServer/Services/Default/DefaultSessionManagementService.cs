...
public class DefaultSessionManagementService : ISessionManagementService
{
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultSessionManagementService.QuerySessions");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultSessionManagementService.RemoveSessions");
