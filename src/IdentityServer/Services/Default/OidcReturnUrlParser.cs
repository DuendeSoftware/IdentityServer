...
internal class OidcReturnUrlParser : IReturnUrlParser
{
    ...
    {
        using var activity = Telemetry.ValidationActivitySource.StartActivity("OidcReturnUrlParser.Parse");
    ...
    {
        using var activity = Telemetry.ValidationActivitySource.StartActivity("OidcReturnUrlParser.IsValidReturnUrl");
