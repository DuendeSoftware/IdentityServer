...
public class DefaultConsentService : IConsentService
{
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultConsentService.RequiresConsent");
    ...
    {
        using var activity = Telemetry.ServiceActivitySource.StartActivity("DefaultConsentService.UpdateConsent");
