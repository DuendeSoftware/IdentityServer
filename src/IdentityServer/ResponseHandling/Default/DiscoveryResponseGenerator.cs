...
public class DiscoveryResponseGenerator : IDiscoveryResponseGenerator
{
    ...
    {
        using var activity = Telemetry.BasicActivitySource.StartActivity("DiscoveryResponseGenerator.CreateDiscoveryDocument");
    ...
    {
        using var activity = Telemetry.BasicActivitySource.StartActivity("DiscoveryResponseGenerator.CreateJwkDocument");
