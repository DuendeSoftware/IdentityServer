...
public class DiscoveryResponseGenerator : IDiscoveryResponseGenerator
{
    ...
    {
        using var activity = Tracing.BaseActivitySource.StartActivity("DiscoveryResponseGenerator.CreateDiscoveryDocument");
    ...
    {
        using var activity = Tracing.BaseActivitySource.StartActivity("DiscoveryResponseGenerator.CreateJwkDocument");
