...
class InMemoryIdentityProviderStore : IIdentityProviderStore
{
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryOidcProviderStore.GetAllSchemeNames");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("InMemoryOidcProviderStore.GetByScheme");
