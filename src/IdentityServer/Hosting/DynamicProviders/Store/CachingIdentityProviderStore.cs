    ...
    where T : IIdentityProviderStore
{
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("CachingIdentityProviderStore.GetAllSchemeNames");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("CachingIdentityProviderStore.GetByScheme");
