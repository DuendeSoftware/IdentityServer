    ...
    where T : IIdentityProviderStore
{
    ...
    {
        using var activity = Instrumentation.StoreActivitySource.StartActivity("CachingIdentityProviderStore.GetAllSchemeNames");
    ...
    {
        using var activity = Instrumentation.StoreActivitySource.StartActivity("CachingIdentityProviderStore.GetByScheme");
