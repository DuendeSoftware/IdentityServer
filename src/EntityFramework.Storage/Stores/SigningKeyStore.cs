...
public class SigningKeyStore : ISigningKeyStore
{
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("SigningKeyStore.LoadKeys");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("SigningKeyStore.StoreKey");
    ...
    {
        using var activity = Telemetry.StoreActivitySource.StartActivity("SigningKeyStore.DeleteKey");
