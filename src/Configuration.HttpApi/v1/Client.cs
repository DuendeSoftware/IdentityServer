...
public class Client
{
    ...
    /// </summary>
    public Secret[] ClientSecrets { get; set; } = Array.Empty<Secret>();
    ...
    /// </summary>
    public string[] AllowedIdentityTokenSigningAlgorithms { get; set; } = Array.Empty<string>();
    ...
    /// </summary>
    public string[] IdentityProviderRestrictions { get; set; } = Array.Empty<string>();
    ...
    /// The claims.
    /// </value>
    public ClientClaim[] Claims { get; set; } = Array.Empty<ClientClaim>();
